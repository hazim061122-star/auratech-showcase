...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Novexa — Premium Tech Gadgets & Accessories" },
      {
        name: "description",
        content:
          "Novexa designs premium wireless audio, wearables and power accessories with obsessive attention to detail.",
      },
      { name: "author", content: "Novexa Labs" },
